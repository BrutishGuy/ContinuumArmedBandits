...
Here you can find a quick tutorial and explanation of how Bayesian optimization works and how to use it. To work with this tutorial and all the examples it provides in the _./examples_ folder, please install the repository _github.com/fmfn/BayesianOptimization.git_
The README and examples in the package are adapted from there.
